package com.github.willcode4fun.tools.faker;

import static org.fest.assertions.Assertions.assertThat;

import java.util.Random;

import com.github.willcode4fun.tools.faker.model.Gender;
...
public class FakeFactoryTest {
    ...
    public void testStreetName() {
        ...
        assertThat(randomSeedFactory.streetName()).isNotNull().isNotEmpty()
                .isNotEqualTo(randomSeedFactory.streetName());
    ...
    public void testStreetAddress() {
        ...
        assertThat(randomSeedFactory.streetAddress()).isNotNull().isNotEmpty()
                .isNotEqualTo(randomSeedFactory.streetAddress());
    }

    @Test
    public void testStreetAddressWithSecondary() {
        assertThat(fixedSeedFactory.streetAddressWithSecondary()).isEqualTo(
                new String[] { "34043 Olaf Motorway", "Apt. 424" });
        assertThat(randomSeedFactory.streetAddressWithSecondary()).isNotNull().isNotEmpty()
                .isNotSameAs(randomSeedFactory.streetAddressWithSecondary());
    }

    @Test
    public void testName() {
        assertThat(fixedSeedFactory.name()).isEqualTo("Tony Cormier");
    ...
    public void testFirstNameGender() {
        ...
        assertThat(randomSeedFactory.firstName(Gender.F)).isNotNull().isNotEmpty()
                .isNotEqualTo(randomSeedFactory.firstName(Gender.F));
        assertThat(randomSeedFactory.firstName(Gender.M)).isNotNull().isNotEmpty()
                .isNotEqualTo(randomSeedFactory.firstName(Gender.M));
    ...
    public void testPhoneNumber() {
        ...
        assertThat(randomSeedFactory.phoneNumber()).isNotNull().isNotEmpty()
                .isNotEqualTo(randomSeedFactory.phoneNumber());

    }

    @Test
    public void testCellPhoneNumber() throws Exception {
        assertThat(fixedSeedFactory.cellPhoneNumber()).isEqualTo("(034)043-7771");
        assertThat(randomSeedFactory.cellPhoneNumber()).isNotNull().isNotEmpty()
                .isNotEqualTo(randomSeedFactory.phoneNumber());
    }
    ...
    public void testSecondaryAddress() {
        ...
        assertThat(randomSeedFactory.secondaryAddress()).isNotNull().isNotEmpty()
                .isNotEqualTo(randomSeedFactory.secondaryAddress());
    ...
    public void testEyeColor() {
        assertThat(fixedSeedFactory.eyeColor()).isEqualTo("black");
        // TODO:too oftenly the same,find a more accurate test
    ...
    public void testEmail() throws Exception {
        assertThat(fixedSeedFactory.email()).isEqualTo("tony.cormier@gmail.com");
    }
}
