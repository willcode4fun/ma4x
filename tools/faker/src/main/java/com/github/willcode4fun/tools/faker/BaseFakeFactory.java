...
import com.github.willcode4fun.tools.faker.utils.BeanUtils;
import com.github.willcode4fun.tools.faker.utils.RandomUtils;
...
public class BaseFakeFactory {
    ...
    public char digit() {
        return DIGITS.charAt(RandomUtils.nextInt(random, DIGITS.length()));
    }
    ...
    public char letter() {
        return LETTERS.charAt(RandomUtils.nextInt(random, LETTERS.length()));
    }
    ...
    public String paragraph(int sentenceCount) {
        return join(sentences(sentenceCount + RandomUtils.nextInt(random, 3)), " ");
    }
