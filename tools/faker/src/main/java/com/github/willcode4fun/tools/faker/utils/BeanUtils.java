...
public class BeanUtils {
    ...
    public static Method findMethod(Class clazz, String name, int numArgs) {
        ...
        throw new IllegalArgumentException(String.format("Unable to find method :%s with %s arguments", name, "" + numArgs));
    }
    ...
    public  static <T> T cast(Object obj, Class<T> targetType) {
        ...
        throw new IllegalArgumentException(String.format("Unsupported argument type : %s arg : %s", targetType.getName(), obj.getClass().getName()));
    }
    ...
    public static Object matchType(Class targetType, Object arg){
        ...
        throw new IllegalArgumentException(String.format("Unsupported argument type : %s arg : %s", targetType.getName(), arg.getClass().getName()));
    }
    ...
    private static Object matchEnum(Class targetType, Object arg) {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format("Unsupported enum argument type : %s", targetType.getName()),e);
        }
    }
    ...
    private static Object matchPrimitive(Class targetType, Object arg) {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format("Unsupported enum argument type : %s",e, targetType.getName(),e));
        }
    ...
    public static PropertyDescriptor descriptorForName(String parameterName, Class beanClass){
        try {
            ...
            throw new IllegalArgumentException(String.format("can not find property descriptor for parameter : %s", parameterName));
        } catch (IntrospectionException e) {
            throw new IllegalArgumentException(String.format("can not find property descriptor for parameter : %s", e, parameterName));
        }
    }
